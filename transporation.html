...
<body>
    ...
    L.tileLayer('https://tile.thunderforest.com/transport/{z}/{x}/{y}.png?apikey=78e13763af064187a6fdae654ae1820f', {
    maxZoom: 18,
    attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors, ' +
      'Imagery © <a href="https://www.mapbox.com/">ThunderForest</a>',
    id: 'Transportation-Map',
    tileSize: 512,
    zoomOffset: -1
  }).addTo(map);
...
contents += '<h3><a href = "https://www.itsmarta.com/">Get more info on Marta</h3>'
contents += '<h5>Instructions</h5>';
